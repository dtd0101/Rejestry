...
@Route("Przegladanie-Skanow")
@Theme(value = Lumo.class, variant = Lumo.DARK)
public class SkanViewing extends HorizontalLayout {
...
////    ScanService scanService;
    ...
    public SkanViewing(@Autowired UIService uiService) {
