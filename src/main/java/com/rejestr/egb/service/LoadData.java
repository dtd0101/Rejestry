...
public class LoadData {
    ...
    private List<RejestrGruntow> allRejestrGruntows = new ArrayList<>();
    private List<Teryt> allTeryts = new ArrayList<>();
...
//                        skanyRepo.saveAll(skanyList);
                        ...
                        skorowidzDzialek.setRok(split[split.length-1]);
                        skorowidzDzialekRepo.save(skorowidzDzialek);
...
//        System.out.println(newPath);
                        ...
                        skorowidzWlascicieli.setRok(split[split.length-1]);
                        skorowidzWlaRepo.save(skorowidzWlascicieli);
...
//            Skany skan4 = new Skany(new File(new File(path).getPath()+"\\RG_006_073.jpg"));
//            skanyList.add(skan4);
            ...
            allRejestrGruntows.add(rejestrGruntow);

        }

    }

    private void comperDeta(){
        for (RejestrGruntow r1: allRejestrGruntows) {

            for (RejestrGruntow r2: allRejestrGruntows) {

                if(!r1.equals(r2)){

                    if(r1.getWlasciciel().retainAll(r2.getWlasciciel()) && r2.getWlasciciel().retainAll(r1.getWlasciciel())){
                        r2.setWlasciciel(r1.getWlasciciel());
                    }

                    if(r1.getDzialki().retainAll(r2.getDzialki()) && r2.getDzialki().retainAll(r1.getDzialki())){
                        r2.setDzialki(r1.getDzialki());
                    }

                    if(r1.getDzialki().get(0).getTeryt().equals(r2.getDzialki().get(0).getTeryt())){
                        Teryt teryt = r1.getDzialki().get(0).getTeryt();
                    }
