...
import com.rejestr.egb.service.UIServiceSkorWla;
...
@Route("Skorowidze-Wlascicieli-SKANY")
@Theme(value = Lumo.class, variant = Lumo.DARK)
public class SkanViewingSkorowidzeWla extends HorizontalLayout {
...
////    ScanService scanService;
    ...
    public SkanViewingSkorowidzeWla(@Autowired UIServiceSkorWla uiService) {
